 ...
 */
(runIntegration ? test : test.skip)(
	"external HostSupervisor verifies an operator-run gjc session through the broker CLI",
	async () => {
		if (!sessionId || !workspace)
			throw new Error("GAJAEWAY_SUPERVISOR_SESSION_ID and GAJAEWAY_SUPERVISOR_WORKSPACE are required.");
